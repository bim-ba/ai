...
Add the marketplace: `/plugin marketplace add bim-ba/ai`

Then enable `core` (and `data` for data projects), or simply clone a project that already lists these plugins in `.claude/settings.json` and run `/setup`.
